...
import { dashboardAssets, projects, type DashboardProject, type ProjectTag } from "../dashboard-data";
...
export function ProjectsPanel() {
  ...
  return (
    <>
      ...
      <EditProjectModal project={selectedProject} onClose={() => setSelectedProject(null)} />
    </>
  );
}
